...
public class AlunoAcceptanceTest {
    ...
    public void cadastrar() throws Exception {
        ...
        // Acessa a página de cadastro de aluno
        wait.until(d -> d.getPageSource().contains("Sistema de Gerenciamento de Alunos"));
        driver.findElement(By.linkText("CADASTRAR ALUNO")).click();

        // Preenche o formulário de cadastro de aluno
        wait.until(d -> d.findElement(By.id("nome")).isDisplayed());
        driver.findElement(By.id("nome")).sendKeys("AlunoExemplo");
        driver.findElement(By.cssSelector(".btn-primary")).click();
        driver.findElement(By.cssSelector(".btn-outline-success")).click();

        // Verifica se o aluno foi cadastrado com sucesso
        wait.until(d -> d.findElement(By.className("table")).isDisplayed());
        Assert.assertTrue(driver.getPageSource().contains("AlunoExemplo"));
    }
}
